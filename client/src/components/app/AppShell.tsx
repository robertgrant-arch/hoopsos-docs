...
const NAV: Record<Role, NavItem[]> = {
  ...
  COACH: [
    ...
    { href: "/app/film", label: "Film Room", icon: <Film className="w-4 h-4" /> },
    { href: "/app/whiteboard", label: "Playbook Studio", icon: <LayoutDashboard className="w-4 h-4" /> },
  ...
  TEAM_ADMIN: [
    ...
    { href: "/app/team/billing", label: "Billing & Seats", icon: <CreditCard className="w-4 h-4" /> },
  ...
  SUPER_ADMIN: [
    ...
    { href: "/app/admin/subscriptions", label: "Subscriptions", icon: <CreditCard className="w-4 h-4" /> },
